...
<html>
  ...
  <body>
    <form action="<%=basePath %>" method="post" name="form" id="form" onsubmit="return validateForm()">
    	<input type="text" name="id" style= "visibility:hidden" value="${computer.id}"/><br/>
    	<input type="text" name="stationId" style= "visibility:hidden" value="${computer.stationId}"/><br/>
    	<hr width="97%" align="center" size=0>
				<table width="95%" border="0" cellpadding="0" cellspacing="0">
					<tr>
						...
						<td width="78%">
							<div align="left">
								<input name="ip" type="text" class="text1" id="ip"
								size="10" maxlength="20" value="${computer.ip}" readonly/>
							</div>
						</td>
					</tr>
					<tr>
						...
						<td width="78%">
							<input name="os" type="text" class="text1" id="os"
								size="10" maxlength="20" value="${computer.os}"/>
						</td>
					</tr>
					<tr>
						<td width="22%" height="29">
						...
						<td width="78%">
							<input name="state" type="text" class="text1" id="state"
								size="10" maxlength="20" value="${computer.state}"/>
						</td>
					</tr>
					<tr>
						<td width="22%" height="29">
						...
						<td width="78%">
							<input name="log" type="button" class="text1" id="log"
								size="10" maxlength="20" value="查看日志" onclick="showLog()"/>
						</td>
					</tr>
				</table>
				<hr width="97%" align="center" size=0>
