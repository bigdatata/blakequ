...
var guides={
	...
	'ShowComputer' : {
		...
		//	'ShowComputer_1' : ['站点编辑','/crc_ip_manager_alpha/page/function/ShowComputer/ShowComputer.jsp',''],
			'ShowComputer_1' : ['电脑台账信息','/crc_ip_manager_alpha/computer_log/get_log_by_page.do?pageNo=1&queryString=',''],
			'ShowComputer_2' : ['路由台账信息','/crc_ip_manager_alpha/router_log/get_log_by_page.do?pageNo=1&queryString=',''],
			'ShowComputer_3' : ['路由端口信息','/crc_ip_manager_alpha/port/get_port_by_page.do?pageNo=1&routerId=','']}},
	...
	'UserManage' : {
		'UserManage_' : {
			...
			'UserManage_2' : ['用户注册','/crc_ip_manager_alpha/admin/show_add_user.do',''],
