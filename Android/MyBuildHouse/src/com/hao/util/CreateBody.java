...
public class CreateBody {
	 ...
	 * @param y y坐标
	 * @param r	半径
	 * @param density body密度
	 * @param isStatic
	 * @param userData  自定义用户数据
	 * @return
	 */
	public Body createCircle(float x, float y, float r, float density, boolean isStatic, Object userData) {
	...
	/**
	 * 设置恢复力,usually in the range [0,1]
	 * @param restitution
	 */
	...
	/**
	 * 设置摩擦力,usually in the range [0,1]
	 * @param friction
	 */
