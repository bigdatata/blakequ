...
public class MyGoodsShopping extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent intent = new Intent(MyGoodsShopping.this,
	...
	private class MyTask extends UserTask<String, Boolean, Boolean>{
		...
		protected void onProgressUpdate(Boolean... values) {
			...
			if(values[0]){
				...
				Toast.makeText(MyGoodsShopping.this, getResources().getString(R.string.mygoods_not_goods), 3000).show();
			}
		}
	...
	private List<Integer> getData(String userID){
		...
		try {
			is = httpClient.doHttpPost2(URLConstant.USER_BUY, new BasicNameValuePair("userID",  userID));
