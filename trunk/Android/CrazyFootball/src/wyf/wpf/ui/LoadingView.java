...
public class LoadingView extends SurfaceView implements SurfaceHolder.Callback{
	...
	public Bitmap bmpProgress;				//显示进度时图片
	public Bitmap [] bmpProgSign;			//进度条上的标志物
	public Bitmap bmpLoad;					//进度条图片对象
	public int progress=0;					//进度，0到100
	public int progY = 330;				//进度条的Y坐标
	public LoadingDrawThread lt;			//LoadingView的刷屏线程	
