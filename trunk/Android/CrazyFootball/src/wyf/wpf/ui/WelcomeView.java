...
public class WelcomeView extends SurfaceView implements SurfaceHolder.Callback{
	public WelcomeThread wt;				//后台修改数据线程
	public WelcomeDrawThread wdt;			//后台重绘线程
	public FootballActivity father;		//Activity的引用
	public int index = 0;					//开场3个动画帧的索引
	public int status = -1;				//0代表足球动画，1代表背景转进来，2代表全部渐显，3代表待命
	public int alpha = 255;				//透明度，初始为255，即不透明
	public int [] layout = {3,3,4};		//玩家球员的站位数组，3个值分别代表前场、中场、后场
	public CustomGallery cg;				//自定义的Gallery类，用于选择俱乐部logo	
	...
	Bitmap bmpBack;					//背景图片
	public Matrix matrix;					//Matrix对象，用来旋转背景图
	//构造器：初始化成员变量
