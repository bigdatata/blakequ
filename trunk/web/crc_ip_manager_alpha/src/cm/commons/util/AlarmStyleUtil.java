...
public class AlarmStyleUtil {
	...
	private static String[] stationColors={"station_normal","station_abnormal","station_unknow"};
	//segmentColors={"segment_normal","segment_abnormal","segment_unknow"};
	private static String[] segmentColors={"segment_normal","segment_abnormal","segment_unknow"};
